...
| `HOLOVANT_SPORTSDB_KEY` | The football card — a paid key to TheSportsDB, which lifts the free tier's cap of five table rows and one fixture | The free key, which shows the top five of the Süper Lig and says so |
